...
<head>
    ...
    <title>Admin Ruang Ternak</title>
            ...
            <div class="logo">
                <a href="#" class="simple-text logo-mini">
                    <div class="logo-image-small">
                        <img src="./assets/img/5a6662d4132c48708d381fa1fc4d7f15.png">
                    </div>
                </a>
                <a href="#" class="simple-text logo-normal">Ruang Ternak</a>
            </div>
                        ...
                        <div class="card radius-10 border-start border-0 border-3 border-warning">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <p class="mb-0 text-secondary"></p>
                                        <h4 class="my-1 text-warning">History</h4>
                                    </div>
                                </div>
