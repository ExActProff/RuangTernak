    ...
    <body>
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <!-- Icon -->
                <div class="fadeIn first" onclick="location.href = 'home.php'">
                <img src="assets/img/5a6662d4132c48708d381fa1fc4d7f15.png" id="icon" alt="User Icon" />
                </div>
                ...
                <form>
                    ...
                    <input type="submit" class="fadeIn fourth" value="login" class>
                </form>
